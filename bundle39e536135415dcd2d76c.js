...
var dom = function () {
  ...
  function loadProject(projectName) {
    ...
    if (project.id !== 'inbox' && project.id !== 'today' && project.id !== 'this-week' && project.id !== 'completed') {
      ...
      var projectRemoveButton = document.createElement('a');
  ...
  function renderTasks(projectName) {
    ...
    _storage__WEBPACK_IMPORTED_MODULE_3__["default"].getList().getProject(projectName).getTasks().forEach(function (task) {
      styleIfCompleted(task.completed, loadTask(task.name, task.dueDate, task.completed, task.id));
    });
  ...
  function loadTask(name, dueDate, isCompleted, taskId) {
    ...
    var taskChangeSection = document.createElement('div');
  ...
  function clearTasks() {
    ...
    closeEditTaskDialog();
    var tasksContainer = document.getElementById('tasks-container');
    var tasks = document.querySelectorAll('[data-task-item]');
  ...
  function clearForms() {
    ...
    var editTaskForm = document.getElementById('form-edit-task');
    projectForm.reset();
    taskForm.reset();
    editTaskForm.reset();
  }
  ...
  function openWeekTasks() {
    _storage__WEBPACK_IMPORTED_MODULE_3__["default"].updateThisWeekProject();
  ...
  function initTaskButtons() {
    ...
    checkboxes.forEach(function (checkbox) {
      return checkbox.addEventListener('click', function (event) {
        return changeTaskCompleteState(event);
      });
    });
  ...
  function changeTaskCompleteState(e) {
    ...
    _storage__WEBPACK_IMPORTED_MODULE_3__["default"].changeTaskCompleteState(projectName, taskName, taskId);
    _storage__WEBPACK_IMPORTED_MODULE_3__["default"].updateCompletedProject();
    renderTasks(projectName);
  }
  ...
  function deleteTask(e) {
    ...
    if (projectName !== 'Completed') {
      if (_storage__WEBPACK_IMPORTED_MODULE_3__["default"].getList().getProject(projectName).getTask(taskId).completed === true) {
        var completedTaskSave = _objectSpread({}, _storage__WEBPACK_IMPORTED_MODULE_3__["default"].getList().getProject(projectName).getTask(taskId));
        console.log(completedTaskSave);
        _storage__WEBPACK_IMPORTED_MODULE_3__["default"].addTask('Completed', completedTaskSave);
      }
    } else {
      _storage__WEBPACK_IMPORTED_MODULE_3__["default"].changeTaskCompleteState(projectName, taskName, taskId);
      _storage__WEBPACK_IMPORTED_MODULE_3__["default"].deleteCompletedTask(taskId);
      renderTasks(projectName);
      return;
    }
    _storage__WEBPACK_IMPORTED_MODULE_3__["default"].deleteTask(taskId);
    renderTasks(projectName);
  }
  function editTask(e) {
    var target = e.target;
    ...
    var taskItem = target.closest('[data-task-item]');
    var taskName = taskItem.children[1].children[0].textContent;
    var taskDate = taskItem.children[1].children[1].textContent;
  ...
  function openEditTaskDialog(taskItem, taskName, taskDate) {
    ...
    var nameInput = document.getElementById('edit-task-name');
    nameInput.value = taskName;
    var dateInput = document.getElementById('edit-task-date');
  ...
  function initEditTaskButtons() {
    var submitEditTaskButton = document.getElementById('button-dialog-edit-task');
    var cancelTaskEditDialogButton = document.getElementById('button-dialog-cancel-edit-task');
  ...
  function updateTask(e) {
    ...
    e.preventDefault();
    _storage__WEBPACK_IMPORTED_MODULE_3__["default"].editTask(projectName, taskId, taskName, taskDueDate);
    clearForms();
    closeEditTaskDialog();
    renderTasks(projectName);
  }
  function preserveEditTaskDialog() {
    var addTaskDialog = document.getElementById('dialog-add-task');
    var editTaskDialog = document.getElementById('dialog-edit-task');
    insertAfter(editTaskDialog, addTaskDialog);
  }
  function formatDate(date) {
    var dateF = 'No date';
    if ((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(date))) {
      dateF = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(date), 'MM/dd/yy');
    }
    return dateF;
  }
...
var List = function () {
  var list = function list() {
    var projects = [];
    projects.push(_project__WEBPACK_IMPORTED_MODULE_1__["default"].project('Inbox'));
    projects.push(_project__WEBPACK_IMPORTED_MODULE_1__["default"].project('Today'));
    projects.push(_project__WEBPACK_IMPORTED_MODULE_1__["default"].project('This week'));
    projects.push(_project__WEBPACK_IMPORTED_MODULE_1__["default"].project('Completed'));
    return {
      projects: projects,
      ...
      updateTodayProject: updateTodayProject,
      updateThisWeekProject: updateThisWeekProject,
      updateCompletedProject: updateCompletedProject
    };
  };
  ...
  function updateTodayProject() {
    ...
    this.projects.forEach(function (project) {
      if (project.getName() === 'Today' || project.getName() === 'This week' || project.getName() === 'Completed') return;
      var todayTasks = project.getTasksToday();
      todayTasks.forEach(function (task) {
        var taskReference = task;
        _this.getProject('Today').tasks.push(taskReference);
      });
    });
  }
  function updateThisWeekProject() {
    ...
    this.projects.forEach(function (project) {
      ...
      weekTasks.forEach(function (task) {
        _this2.getProject('This week').tasks.push(task);
      });
    });
  }
  function updateCompletedProject() {
    var _this3 = this;
    this.getProject('Completed').tasks = this.getProject('Completed').getTasksCompleted();
    this.projects.forEach(function (project) {
      if (project.getName() === 'Today' || project.getName() === 'This week' || project.getName() === 'Completed') return;
      var completedTasks = project.getTasksCompleted();
...
var Storage = function () {
  ...
  function changeTaskCompleteState(projectName, taskName, taskId) {
    var list = getList();
    var isCompleted = list.getProject(projectName).getTask(taskId).getCompleted();
    var completed;
    if (isCompleted) {
  ...
  return {
    ...
    taskExistsOutsideCompleted: taskExistsOutsideCompleted
  };
}();
...
var Task = function () {
  // PROJECT FACTORY
  var task = function task(name, dueDate, priority) {
  ...
  function getDateFormatted() {
    var dateF = 'No date';
    if ((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(this.dueDate))) {
      dateF = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(this.dueDate), 'MM/dd/yy');
    }
    return dateF;
  }
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("/edit.svg");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("/trash.svg");
...
/* harmony import */ var _assets_trash_svg__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./assets/trash.svg */ "./src/assets/trash.svg");
/* harmony import */ var _assets_edit_svg__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./assets/edit.svg */ "./src/assets/edit.svg");
...
/******/ })()
;
//# sourceMappingURL=bundle39e536135415dcd2d76c.js.map